                ...
                <el-col :span="17">
                    <el-card>
                        <el-row class="status">
                            ...
                            <el-col :span="4">
                                <el-button  @click="choose" size="mini">选定</el-button>
                            </el-col>
                        </el-row>
...
<script>
    export default {
        ...
        methods: {
           ...
           //         "/wheelTakein/flushWheelInfo?id="+wheelId+"&index="+index);
           //     if (result.data.code != 100){
           //         alert("添加失败");
           //         return ;
           //     }
           ...
           async showitem(item,index,e){
               ...
               for (var i=0;i<this.savedInfo.length;i++){
                ...
                if (item.isMeasureFinish == '1'){
                    ...
                    //已完成从数据库内查找，提交到显示表单
                    var result = await this.$http.get(
                        "/wheelTakein/findMeasureById?id="+item.wheelId);
                    if (result.data.code != 100){
                        alert("添加失败");
                        return ;
                    }
